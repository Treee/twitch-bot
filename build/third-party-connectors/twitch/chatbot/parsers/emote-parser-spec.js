...
describe('Emote Parser', () => {
    ...
    describe('parseComplete', () => {
        it('returns a list of emotes and combo emotes used', () => {
            const expectedResult = [
                { type: emote_parser_1.ComboType.Sequence, data: ['Squid1', 'Squid2', 'Squid3', 'Squid4'] },
                { type: emote_parser_1.ComboType.LeftRight, data: ['PowerUpL', 'itsatrEeToast', 'PowerUpR'] },
                { type: emote_parser_1.ComboType.LeftRight, data: ['PowerUpL', 'itsatrEeToast', 'PowerUpR'] },
                { type: emote_parser_1.ComboType.None, data: ['itsatrEeCool', 'itsatrEeCool', 'itsatrEeToast', 'itsatrEeToast'] }
            ];
    ...
    describe('checkForComboEmotes', () => {
        ...
        it('can find a sequence of emotes that are on the left and right using special suffixes', () => {
            const expectedResult = [
                { type: emote_parser_1.ComboType.LeftRight, data: ['PowerUpL', 'itsatrEeToast_SA', 'PowerUpR'] }
            ];
            const parsableEmotes = ['test1', 'test2', 'itsatrEeToast'];
