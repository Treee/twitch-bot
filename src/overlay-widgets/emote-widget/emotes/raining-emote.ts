import { RenderableObject, Movable, Rotatable, Hideable, Drawable, Vector2 } from './emote-interfaces';

export class RainingEmote extends RenderableObject implements Movable, Rotatable, Hideable, Drawable {
    opacity: number = 1;
