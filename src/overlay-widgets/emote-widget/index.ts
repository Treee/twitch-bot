...
// const emoteSetIds = [twitchDefault, textEmojiDefault, amazonPrimeDefault, membTier1, membTier2, membTier3];
...
Promise.all([
    ...
    if (emoteWidgetConfig.botMode) {
        new EmoteWidgetClient('wss://www.itsatreee.com/emotewidgetmembtv', emoteWidget);
